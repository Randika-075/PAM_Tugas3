    ...
    <View style={styles.container}>
      <View style={styles.header}>
          <View style={styles.top}>
            ...
            <Text style={styles.heading}>Liburan.com</Text>
      ...
      <Text style={styles.copyright}>Copyright Randika Sagala - 120140075</Text>
    </View>
  );
}
